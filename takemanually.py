        ...
        if subb == "":
            ...
            def enter_data_DB():
                ...
                if ENROLLMENT == "":
                    ...
                    if index == 0:
                        d = {
                            index: {"Register No": ENROLLMENT, "Name": STUDENT, Date: 1}
                        }
                        index += 1
                        ENR_ENTRY.delete(0, "end")
                        STUDENT_ENTRY.delete(0, "end")
                    else:
                        d[index] = {"Register No": ENROLLMENT, "Name": STUDENT, Date: 1}
                        index += 1
                        ENR_ENTRY.delete(0, "end")
                        STUDENT_ENTRY.delete(0, "end")
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "E:\\Mini project\\FRS\\Attendance(Manually)\\"
                    + subb
                    + "_"
                    + Date
                    + "_"
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'explorer /select,"E:\\Mini project\\FRS/Attendance(Manually)"'
                )
